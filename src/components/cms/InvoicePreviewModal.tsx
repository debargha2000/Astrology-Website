    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center space-y-1.5 border-b border-stone/40 pb-6">
          <span className="font-serif text-xl font-bold tracking-[0.2em] uppercase text-ink">AURA & STONE</span>
        ...
        <div className="font-mono text-[10.5px] grid grid-cols-2 gap-4 pb-4 border-b border-cream text-ink/75">
          <div>
            <span className="block text-[8px] text-gold-muted uppercase font-bold leading-none mb-1">Voyager Client Ledger</span>
            <strong className="text-sm font-serif font-semibold text-ink">{invoice.client}</strong>
            <span className="block text-[9.5px] mt-1 text-clay">Ethereal Station Account Match</span>
          </div>
          <div className="text-right">
            <span className="block text-[8px] text-gold-muted uppercase font-bold leading-none mb-1">Invoice Coordinates</span>
          ...
          <div className="border border-stone/50 rounded-xl overflow-hidden text-xs">
            ...
            <div className="p-4 grid grid-cols-12 items-center text-ink">
              <div className="col-span-8 space-y-1">
                ...
                <span className="block text-[10px] font-mono text-gold-muted">{invoice.alignment}</span>
              </div>
              <span className="col-span-1 text-center font-mono">1</span>
              <span className="col-span-3 text-right font-mono font-bold">₹{invoice.amount.toLocaleString('en-IN')}</span>
            </div>
        ...
        <div className="font-mono text-xs flex justify-between items-center bg-cream p-4 rounded-xl border border-double border-stone text-right font-bold text-ink">
          <div className="text-left">
            <span className="block text-[8px] text-gold-muted uppercase font-bold leading-none mb-1">Ledger Status</span>
            <span
          ...
          <div>
            <span className="block text-[8.5px] text-gold-muted uppercase leading-none mb-1">Grand Total</span>
            <span className="text-base font-serif font-bold text-ink">₹{invoice.amount.toLocaleString('en-IN')}</span>
          </div>
        </div>
        ...
        <div className="flex items-end justify-between pt-6 border-t border-stone/40 font-mono text-[9px] text-gold-muted">
          ...
          <div className="text-center">
            <span className="block font-serif font-bold italic text-xs text-ink leading-none mb-1">P. Shastry</span>
