...
export const REVIEWS: Review[] = [
  {
    ...
    avatarUrl:
      'https://api.dicebear.com/7.x/initials/svg?seed=AM&backgroundColor=d4af37&fontFamily=Inter',
  },
  {
    id: 'rev-2',
    ...
    avatarUrl:
      'https://api.dicebear.com/7.x/initials/svg?seed=PS&backgroundColor=1a365d&fontFamily=Inter',
  },
  {
    id: 'rev-3',
    ...
    avatarUrl:
      'https://api.dicebear.com/7.x/initials/svg?seed=VA&backgroundColor=2d3748&fontFamily=Inter',
  },
  {
    id: 'rev-4',
    ...
    avatarUrl:
      'https://api.dicebear.com/7.x/initials/svg?seed=RD&backgroundColor=702963&fontFamily=Inter',
  },
  {
    id: 'rev-5',
    ...
    productTitle: 'The Aura & Stone Money Magnet Bracelet',
    avatarUrl:
      'https://api.dicebear.com/7.x/initials/svg?seed=NK&backgroundColor=2c5282&fontFamily=Inter',
  },
];
...
export const CRYSTAL_ENCYCLOPEDIA: Record<string, CrystalDetails> = {
  Citrine: {
    ...
    chakra:
      'Solar Plexus Chakra (Manipura) - Center of personal authority, power, and wealth creation',
    ...
    scientificFacts:
      'Natural Citrine is incredibly rare. The beautiful golden hue is caused by sub-microscopic iron colloid distribution inside the clear quartz lattice during volcanic shifts millions of years ago.',
    hexColor: '#EAA835',
  },
  Pyrite: {
    name: 'Pyrite',
    ...
    scientificFacts:
      'Pyrite grows naturally in perfect cube and pyritohedron formations. Its brassy metallic luster reflects light beautifully, which ancient shamans used as sacred diagnostic mirrors.',
    hexColor: '#D4AF37',
  },
  'Green Aventurine': {
    ...
    chakra:
      'Heart Chakra (Anahata) - Center of emotional healing, luck, and alignment to lucky paths',
    ...
    scientificFacts:
      'The glistening emerald sparkle of Indian Aventurine is caused by tiny scattered platelets of green chromium-rich Fuchsite mica that align horizontally within the quartz.',
    hexColor: '#2D7F5E',
  },
  'Black Tourmaline': {
    ...
    scientificFacts:
      'Black Tourmaline is highly pyroelectric and piezoelectric. Heating or rubbing the crystal causes it to accumulate an electrical charge, physically attracting lightweight dust or ash.',
    hexColor: '#1A1A1A',
  },
  Amethyst: {
    ...
    scientificFacts:
      'Amethyst owes its royal violet color to natural irradiation replacing silicon atoms with iron ions inside the quartz. If left under strong, continuous solar rays, the color can fade beautifully.',
    hexColor: '#702963',
  },
  'Lapis Lazuli': {
    name: 'Lapis Lazuli (The Stone of Royalty)',
    formula:
      'Alosilicate mineral complex rich in Lazurite, Calcite, and bright speckles of gold Pyrite',
    ...
    scientificFacts:
      'Lapis Lazuli is not a single mineral; it is a metamorphic rock. Its deep blue color derives from sulfur radical ions in the Lazurite complex, sparkling with real gold inclusions of Iron Pyrite.',
    hexColor: '#112255',
  },
};
