...
const NAKSHATRA_FULL: {
...
}[] = [
  {
    ...
    interpretation:
      'You embody the spirit of swift healing and new beginnings. Your inner nature moves with the speed and grace of a horse, initiating action with courage and restoring balance through natural vitality.',
    lord: 'Ketu',
  },
  {
    name: 'Bharani',
    ...
    interpretation:
      'You carry the creative force of life and the wisdom of transition. Ruled by Yama, you understand cycles of birth, death, and rebirth, and you transform restraint into artistic and spiritual power.',
    lord: 'Venus',
  },
  {
    name: 'Krittika',
    ...
    interpretation:
      'Your inner fire cuts through illusion with precision. You are a purifying force, sharpening truth from confusion, and you lead with courage, clarity, and the warmth of focused intention.',
    lord: 'Sun',
  },
  {
    name: 'Rohini',
    ...
    interpretation:
      'You are magnetic, fertile, and deeply creative. Ruled by Brahma, you attract beauty, abundance, and devotion, and you flourish when cultivating the arts, nature, and sensual pleasures of life.',
    lord: 'Moon',
  },
  {
    name: 'Mrigashira',
    ...
    interpretation:
      'Your soul is a gentle seeker, ever-curious and always searching for meaning. You wander with the grace of a deer, drawn to beauty, knowledge, and the soft light of intellectual and spiritual truth.',
    lord: 'Mars',
  },
  {
    name: 'Ardra',
    ...
    interpretation:
      'You carry the storm and the tear that brings renewal. Ruled by Rudra, you transform pain into wisdom, destruction into creation, and you emerge from every storm with greater depth and strength.',
    lord: 'Rahu',
  },
  {
    name: 'Punarvasu',
    ...
    interpretation:
      'You are a source of renewal and boundless optimism. Like the mother of gods, you nurture growth, restore hope, and you return again and again to beginnings with the wisdom of experience.',
    lord: 'Jupiter',
  },
  {
    name: 'Pushya',
    ...
    interpretation:
      'You embody nourishment, devotion, and spiritual abundance. The lotus rises from muddy waters, and so do you — flourishing through discipline, generosity, and connection to divine wisdom.',
    lord: 'Saturn',
  },
  {
    name: 'Ashlesha',
    ...
    interpretation:
      'Your wisdom coils like a serpent, holding ancient mysteries and intuitive power. You see what others miss, you feel what others fear, and you transform through deep, kundalini-like inner fire.',
    lord: 'Mercury',
  },
  {
    name: 'Magha',
    ...
    interpretation:
      'You carry the dignity of ancestral kings and queens. Your throne is built on lineage, tradition, and the wisdom of those who came before. You lead with inherited grace and quiet authority.',
    lord: 'Ketu',
  },
  {
    name: 'Purva Phalguni',
    ...
    interpretation:
      'You are a creator of beauty, pleasure, and restful joy. Ruled by the god of delight, you find sacredness in leisure, love, and artistic expression, and you attract abundance through charm.',
    lord: 'Venus',
  },
  {
    ...
    interpretation:
      'You build lasting partnerships and patronize the success of others. Your contracts are sacred, your friendships enduring, and you find joy in committing to love, art, and worthy causes.',
    lord: 'Sun',
  },
  {
    name: 'Hasta',
    ...
    interpretation:
      'Your hands are channels of skilled creation and healing. You manifest ideas into form, you craft with dexterity, and you bring light into matter through practical, dexterous intelligence.',
    lord: 'Moon',
  },
  {
    name: 'Chitra',
    ...
    interpretation:
      'You are a builder of brilliant beauty and architectural vision. Ruled by the celestial architect, you craft lasting works of art, design, and structure that shine with cosmic intelligence.',
    lord: 'Mars',
  },
  {
    name: 'Swati',
    ...
    interpretation:
      'You are the wind — self-driven, flexible, and unattached. You thrive in freedom, you bend without breaking, and you carry the seeds of change wherever you go, scattering possibility with grace.',
    lord: 'Rahu',
  },
  {
    name: 'Vishakha',
    ...
    interpretation:
      'You are a determined achiever who walks through the archway of victory. Your ambition is fueled by both divine authority and sacred fire, and you reach your goals through focused, transformative effort.',
    lord: 'Jupiter',
  },
  {
    name: 'Anuradha',
    ...
    interpretation:
      'You are the lotus of devoted friendship. Your heart blossoms in loyal companionship, you honor commitments with grace, and you channel divine friendship into all your relationships.',
    lord: 'Saturn',
  },
  {
    name: 'Jyeshtha',
    ...
    interpretation:
      'You carry the wisdom of the elder and the protection of sacred amulets. Your authority comes from experience, your power from responsibility, and you protect what you love with fierce devotion.',
    lord: 'Mercury',
  },
  {
    name: 'Mula',
    ...
    interpretation:
      'You are the root — the investigator who digs to the foundation. You pull up what is hidden, you destroy to renew, and you find spiritual liberation in letting go of all that is not essential.',
    lord: 'Ketu',
  },
  {
    name: 'Purva Ashadha',
    ...
    interpretation:
      "You are the invincible flow of water and the strength of the elephant's tusk. You persuade through grace, you cannot be subdued, and you channel divine inspiration into lasting, purifying form.",
    lord: 'Venus',
  },
  {
    name: 'Uttara Ashadha',
    ...
    interpretation:
      'You are a universal victor whose word is law. Your commitments are unbreakable, your victories earned through patience, and you champion truth that serves the greater cosmic order.',
    lord: 'Sun',
  },
  {
    name: 'Shravana',
    ...
    interpretation:
      'You are the eternal listener, the one who hears the universe. Your wisdom comes through deep attention, your learning is vast, and you connect with cosmic truth through humility and sacred listening.',
    lord: 'Moon',
  },
  {
    name: 'Dhanishta',
    ...
    interpretation:
      'You beat the drum of material and spiritual abundance. Your rhythm is prosperity, your song is fame, and you march to the beat of cosmic order, achieving wealth and recognition through discipline.',
    lord: 'Mars',
  },
  {
    name: 'Shatabhisha',
    ...
    interpretation:
      'You are the healer of the hidden hundred stars. Your medicine is mysterious, your boundaries cosmic, and you cure through the veil of secrecy, herbs, and divine intervention.',
    lord: 'Rahu',
  },
  {
    ...
    interpretation:
      'You carry the two-faced sword of spiritual intensity. You burn with ascetic fire, you sever illusions with precision, and you stand at the threshold between the material and the divine.',
    lord: 'Jupiter',
  },
  {
    ...
    interpretation:
      'You are the depth of the cosmic serpent, the profound wisdom of the deep sea. Your patience is infinite, your compassion vast, and you draw strength from the hidden depths of existence.',
    lord: 'Saturn',
  },
  {
    name: 'Revati',
    ...
    interpretation:
      'You are the journeyer, the nourisher, the safe passage. Ruled by the protector of travelers, you guide souls home, you nurture with cosmic love, and you move between worlds with grace.',
    lord: 'Mercury',
  },
];
...
function nakshatraFromLongitude(lon: number): {
  name: string;
  lord: string;
  pada: number;
  sign: string;
...
function computeMC(lstHours: number, oblDeg: number): number {
  ...
  return normalizeAngle(
    (Math.atan2(Math.sin(lstRad) * Math.cos(oblRad), Math.cos(lstRad)) * 180) / Math.PI
  );
}
